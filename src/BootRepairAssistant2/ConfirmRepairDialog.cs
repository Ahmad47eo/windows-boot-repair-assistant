...
internal sealed class ConfirmRepairDialog : Form
{
        ...
        bool testMode)
    {
        ...
        var text = new TextBox
        {
            ...
            Text = BuildDetails(report, command, backup, testMode)
        };
        ...
        {
            ok.Enabled = confirmation.Text == "REPAIR";
        };
    ...
    private static string BuildDetails(
        ...
        bool testMode)
    {
        var operation = testMode
            ? "Test Mode will simulate this operation and make no changes."
            : "This will modify boot files after creating a backup.";
        return
            $"Detected firmware: {report.Firmware.Mode}\r\n" +
